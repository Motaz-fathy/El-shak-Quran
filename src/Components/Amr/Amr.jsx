...
const Amr = () => {
    ...
    return (
        <div className="amr  my-20  relative" >
            <div className="box flex flex-col lg:flex-row gap-10">
                ...
                <img className='amrImg w-full lg:w-2/3 ' src={lab} alt="" />
            </div>
            {vedio.map((item, index) => (
                <div key={index} className={`vedio max-w-[210px] h-[160px] md:h-[300px] md:max-w-[450px] bg-[red] absolute top-[72%] left-[24%] md:left-[${isEnglish ? "52%" : "16%"}] md:top-[25%] rounded-lg overflow-hidden cursor-pointer`}>
                    <video
