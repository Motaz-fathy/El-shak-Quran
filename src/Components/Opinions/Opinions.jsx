        ...
        <div className="opinions mt-20 mb-10">
            ...
            <div className="bigBox flex flex-col gap-5 mt-10">
                {data.map((item, index) => {
                    ...
                    return (
                        <div className="box p-7 shadow-lg rounded-[10px] bg-[--main-bgLight-color] flex items-center w-[100%]" key={index}>
                            <div>
                                {/* User name */}
                                <h6 className="font-[500] text-[28px]">{item.name || 'مستخدم مجهول'}</h6>
                                {/* Comment */}
                                <p className="comment text-[18px]">{item.comment}</p>
                            </div>
