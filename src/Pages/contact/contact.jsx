    ...
    return (
        ...
        <div className=' w-[100%] relative'>
            ...
            <div className='w-[200px] absolute top-[-150px] left-[100px]' >
                ...
                <img src={photo} className=' rounded-lg shadow-md flex-col justify-center items-center mr-[50px] bg-[--main-dark-color] ' alt="" />
              </div>
              <div className='w-[100%]'>
